...
#        print dt,daytype,power,dt_formate,t_formate
        cur.execute("insert into powerConsume_detail(cityName,datetime,daytype,time,power_consume,year,month,day) values('%s','%s','%s','%s',%f,%i,%i,%i)" % (cityname, dt_formate, daytype, t_formate, power, year, month, day))
