...
#    for index in range(1):
        ...
        cur.execute("INSERT INTO `powerforest`.`sw_history` (`powerConsume`,`detailNum` ,`cityName`,`date`, `year`, `month`, `day`, `daytype`) VALUES (%f, %i,'%s', '%s', '%i', '%i',%i, '%s')"%row)
